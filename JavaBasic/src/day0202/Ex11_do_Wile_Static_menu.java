...
import day0201.Ex02_Menu;

import java.util.Scanner;

public class Ex11_do_Wile_Static_menu {
...
//        Ex11_do_Wile_Static_menu menu = new Ex11_do_Wile_Static_menu();
        while (true) {
            switch (Ex11_do_Wile_Static_menu.displayMenu()) {
                case 1:
                    Ex11_do_Wile_Static_menu.inputRecord();
                    break;
                case 2:
                    Ex11_do_Wile_Static_menu.deleteRecord();
                    break;
                case 3:
                    Ex11_do_Wile_Static_menu.sortRecord();
                    break;
                case 4:
